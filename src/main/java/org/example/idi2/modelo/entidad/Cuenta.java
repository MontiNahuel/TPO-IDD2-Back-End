...
public class Cuenta {
    ...
    public Cuenta(String name, String username, String password, String email, String direccion, int documento) {
        this.name = name;
    ...
    public void setMetodoDePago(List<MetodoDePago> metodoDePago) {
